                ...
                <div class="container-fluid px-4">
                    ...
                    <div className="row">
                        <form action="">
                            ...
                            <label className="form-label mt-3" name="language">
                                Language:{' '}
                            </label>
                            <input
                                type="text"
                            ...
                            <label className="form-label mt-3" name="publishingCompany">
                                Publisher:{' '}
                            </label>
                            <input
                                type="text"
                                className="form-control display-2"
                                onChange={(e) => {
                                    setPublishingCompany(e.target.value);
                                }}
                            />

                            <label className="form-label mt-3" name="page">
                                Pages:{' '}
                            </label>
                            <input
                                type="number"
                            ...
                            <label className="form-label mt-3" name="previewAvailable">
                                Preview:{' '}
                            </label>
                            <textarea
                                className="form-control display-2"
                            ...
                            <label className="form-label mt-3" name="detailHead">
                                Detail Head:{' '}
                            </label>
                            <textarea
                                className="form-control display-2"
                                onChange={(e) => {
                                    setDetailHead(e.target.value);
                                }}
                            ></textarea>

                            <label className="form-label mt-3" name="detailLast">
                                Detail Last:{' '}
                            </label>
                            <textarea
                                className="form-control display-2"
                                onChange={(e) => {
                                    setDetailLast(e.target.value);
                                }}
                            ></textarea>
                            ...
                            <label className="form-label mt-3" name="people">
                                Main Character:{' '}
                            </label>
                            <input
                                type="text"
                            ...
                            <label className="form-label mt-3" name="places">
                                Places:{' '}
                            </label>
                            <textarea
                                className="form-control display-2"
                            ...
                            <label className="form-label mt-3" name="publishedIn">
                                Publish In{' '}
                            </label>
                            <input
                                type="date"
                            ...
                            <label className="form-label mt-3" name="versionNotes">
                                Version:{' '}
                            </label>
                            <input
                                type="text"
                            ...
                            <label className="form-label mt-3" name="LinkedOut">
                                {' '}
                                Other Libraries:{' '}
                            </label>
                            <input
